  ...
  return (
    <div>
      ...
      <div className="relative  lg:mt-0 md:mt-0  ">
        ...
        <div className="max-w-[1140px] min-h-[500px] flex mx-auto relative items-center">
          <div className="w-full relative flex min-h-1">
            <div className="p-[10px] w-full  content-start flex flex-wrap">
              <div className="text-center w-full">
                <h1 className="md:text-[40px] py-4  text-3xl text-[#000000] font-bold">
                  Business Portfolio
                </h1>
              </div>
              <div className="text-center mt-[20px]">
                <p className="font-normal lg:leading-[60px] leading-10 text-justify px-4 lg:text-center  text-xl lg:text-3xl  md:px-10 ">
            ...
            <div className="relative pt-[70px] pb-[180px] overflow-hidden w-[100%] mx-auto">
              <div className="box-border w-full gap-x-[2rem] flex md:flex-row gap-y-10 flex-col md:max-w-[960px] xl:max-w-[95.5%] mx-auto h-[100%]">
                <div className="md:px-2 md:w-[50%] w-full flex flex-col justify-center md:items-start items-center">
                  ...
                  <h1 className=" sm:text-4xl text-[35px] md:leading-[48px] leading-[45px] md:text-start text-center mb-5 md:font-bold font-semibold text-black">
      ...
      <div className="bg-bg-color">
        <div className="flex relative mx-auto box-border  h-full">
          <div className="home-touch-bg md:py-[110px] py-[20px]">
            ...
            {/* Get in touch */}
            <div className="box-border w-full gap-x-[2rem] justify-between flex max-w-[960px] xl:max-w-[91.5%] ml-auto mr-auto  relative px-3">
              <div className="flex lg:flex-row flex-col w-full justify-between items-center box-border">
                <div className="xl:max-w-[58.3%] md:max-w-[90%] ">
                  <div className="  relative mb-10 md:mb-0 md:-mt-20">
                    <span 
                      className="relative uppercase font-bold pl-[55px] inline-block mb-[14px] text-blue text-center
                  before:absolute before:w-[40px] before:h-[2px] before:bg-blue before:top-[6px] before:left-0
                  after:absolute after:w-[40px] after:h-[2px] after:bg-blue after:bottom-[6px] after:left-0 text-base"
                ...
                {/* form  */}
                <div className="md:px-2 xl:w-[45%] mt-12 w-full md:max-w-[80%] z-50 rounded-md lg:mt-10 -mb-14 md:mb-0">
                  <div className="bg-white w-full overflow-hidden p-8 ">
                    <h2 className="text-3xl my-8 text-center font-bold text-black">
                      Free Consultation
                    </h2>
                    {/* formik form  */}
                    <Formik
                      ...
                      {({ handleSubmit, isValid, dirty }) => (
                        <Form onSubmit={handleSubmit}>
                          <div className=" md:px-8 ">
                            <div className="bg-[#F4F4F4] mb-[20px] h-[60px]  rounded-md outline-none lg:gap-x-8 gap-x-5 gap-y-8">
                              <Field name="name">
                                {({ field }) => (
                                  <input
                                    {...field}
                            ...
                            <div className="bg-[#F4F4F4] mb-[20px] h-[60px]  w-full rounded-md outline-none lg:gap-x-8 gap-x-5 gap-y-8">
                              <Field name="email">
                                {({ field }) => (
                                  <input
                                    {...field}
                            ...
                            <div className="w-full mb-[20px] bg-[#F4F4F4] ">
                              <Field name="message">
                                {({ field }) => (
                                  <textarea
                                    {...field}
                            ...
                            <div className="w-full flex justify-center">
                              <button
                                ...
                                className={`btn-sub z-[3] inline-flex items-center bg-blue text-base font-semibold text-center px-5 md:px-10 justify-center overflow-hidden relative text-[#FFFFFF] uppercase py-3 md:py-5 rounded-[5px] mx-auto ${
                                  !(isValid && dirty)
