...
const Footer = () => {
  return (
    <>
      {/* subscribe section */}
      <div className="bg-blue box-border mt-24  p-4 md:p-12  lg:p-16 flex items-center  flex-col lg:flex-row    lg:mt-2 ">
        <div className=" lg:w-[50%] w-full  ">
          <h2 className="font-bold text-[#FFFFFF] md:text-[30px] xl:text-[45px] sm:text-3xl text-xl md:text-start text-center xl:leading-[55px]">
            Stay Informed, Subscribe To Our Newsletter
          </h2>
        </div>

        <div className=" mt-8 bg-[#FFFFFF] w-full  lg:w-[50%] flex py-2 pr-2 rounded-md shadow-md shadow-dark-blue">
          <input
            type="email"
            name="email"
            id="email"
            placeholder="Email Adress"
            className="bg-transparent text-text-black border-none outline-none w-full lg:px-6 px-2  py-1 placeholder:text-base placeholder:text-[#a3a3a3] font-light"
          />
          <button
            className="z-[3] inline-flex items-center bg-blue text-base font-semibold text-center justify-center
                                                  overflow-hidden relative text-[#FFFFFF] md:uppercase md:w-[33%] w-[100%] py-1 md:py-4 rounded-md btn-sub"
          >
            Subscribe Now
          </button>
        </div>
